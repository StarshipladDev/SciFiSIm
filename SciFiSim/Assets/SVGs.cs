...
namespace SciFiSim.Assets
{
    public class SVGs
    {
        ...
        public static string GetSmiley(bool isNormal)
        {
            ...
            "<body><div>test!</div><br><svg width='100' height='100' x='0' y='0'>" + (isNormal? SVGs.smileySvg : SVGs.smileySvgMoved )+ "</svg>"+
            "<script> function moveCircle(){ document.getElementById('circle').setAttribute('cy',70);}</script>\"+</body></html>";
        }
    }
}
